using MyRepository = MapPin.Administration.Repositories.UserPermissionRepository;
using MyRow = MapPin.Administration.UserPermissionRow;

namespace MapPin.Administration.Endpoints;
